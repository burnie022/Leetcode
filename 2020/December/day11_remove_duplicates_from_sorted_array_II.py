...
Example 2:
    ...
    modified to 0, 0, 1, 1, 2, 3 and 3 respectively. It doesn't matter what values are set beyond the
    returned length.
...
# More efficient solution that, as requested, uses O(1) space and should also be slightly faster
